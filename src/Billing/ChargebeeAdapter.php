...
final class ChargebeeAdapter implements BillingAdapter
{
    ...
    {
        return ['chargebee_metadata_boundary', 'local_trials', 'local_entitlements'];
    }

    private function ensureAvailable(): void
    {
        $this->requireAnyClass('ChargebeeAdapter', ['ChargeBee\\ChargeBee\\Models\\Subscription', 'ChargeBee\\Environment']);
    }
}
